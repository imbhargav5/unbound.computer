...
import { EditorEvents, EditorProvider, JSONContent, useCurrentEditor } from '@tiptap/react';
      ...
      <div className="button-group flex flex-wrap gap-1">
        ...
        <button
          ...
          className={cn(
            ...
            'bg-white hover:bg-gray-100 border border-gray-300',
            'disabled:opacity-50 disabled:cursor-not-allowed',
            editor.isActive('code') ? 'bg-gray-200 text-gray-900' : 'text-gray-700'
          )}
        >
          Code
        </button>
        ...
        <button
          ...
          className={cn(
            ...
            'bg-white hover:bg-gray-100 border border-gray-300',
            'disabled:opacity-50 disabled:cursor-not-allowed',
            editor.isActive('paragraph') ? 'bg-gray-200 text-gray-900' : 'text-gray-700'
          )}
        >
          Paragraph
        </button>
        ...
        <button
          ...
          className={cn(
            ...
            'bg-white hover:bg-gray-100 border border-gray-300',
            'disabled:opacity-50 disabled:cursor-not-allowed',
            editor.isActive('heading', { level: 4 }) ? 'bg-gray-200 text-gray-900' : 'text-gray-700'
          )}
        >
          H4
        </button>
        <button
          ...
          className={cn(
            ...
            'bg-white hover:bg-gray-100 border border-gray-300',
            'disabled:opacity-50 disabled:cursor-not-allowed',
            editor.isActive('heading', { level: 5 }) ? 'bg-gray-200 text-gray-900' : 'text-gray-700'
          )}
        >
          H5
        </button>
        <button
          ...
          className={cn(
            ...
            'bg-white hover:bg-gray-100 border border-gray-300',
            'disabled:opacity-50 disabled:cursor-not-allowed',
            editor.isActive('heading', { level: 6 }) ? 'bg-gray-200 text-gray-900' : 'text-gray-700'
          )}
        >
          H6
        </button>
        ...
        <button
          ...
          className={cn(
            ...
            'bg-white hover:bg-gray-100 border border-gray-300',
            'disabled:opacity-50 disabled:cursor-not-allowed',
            editor.isActive('textStyle', { color: '#958DF1' }) ? 'bg-gray-200 text-gray-900' : 'text-gray-700'
          )}
        >
          Purple
        </button>
