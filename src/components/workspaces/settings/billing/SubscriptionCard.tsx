...
export function SubscriptionCard({ subscription }: SubscriptionCardProps) {
  ...
  const amount = normalizePriceAndCurrency(billing_prices.amount, billing_prices.currency);
  ...
  return (
    ...
    >
      ...
      <CardContent className="space-y-4 pt-4">
        ...
        <T.P className="text-sm italic text-gray-600 mt-4">{getSubscriptionMessage()}</T.P>
      </CardContent>
    </MotionCard>
  );
}
