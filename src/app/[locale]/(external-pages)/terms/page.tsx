...
export default function TermsPage() {
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <Card className="mt-6">
        <CardHeader>
          <CardTitle><T.H2>1. Example Section</T.H2></CardTitle>
        </CardHeader>
        <CardContent>
          <T.P>
            This is an example of how a section in your Terms of Service might be structured. Replace this text with your actual terms and conditions.
          </T.P>
        </CardContent>
      </Card>
      ...
      <Card className="mt-6">
        <CardHeader>
          <CardTitle><T.H2>2. Placeholder Content</T.H2></CardTitle>
          <CardTitle><T.H2>2. Use of Service</T.H2></CardTitle>
        </CardHeader>
        <CardContent>
          <T.P>
            You agree to use our service only for lawful purposes and in accordance with these Terms of Service. You are prohibited from violating or attempting to violate the security of the service.
          </T.P>
        </CardContent>
      </Card>
      ...
      <Card className="mt-6">
        <CardHeader>
          <CardTitle><T.H2>3. Intellectual Property</T.H2></CardTitle>
        </CardHeader>
        <CardContent>
          <T.P>
      ...
      <Card className="mt-6">
        <CardHeader>
          <CardTitle><T.H2>4. Termination</T.H2></CardTitle>
        </CardHeader>
        <CardContent>
          <T.P>
      ...
      <Card className="mt-6">
        <CardHeader>
          <CardTitle><T.H2>5. Limitation of Liability</T.H2></CardTitle>
        </CardHeader>
        <CardContent>
          <T.P>
      ...
      <Card className="mt-6">
        <CardHeader>
          <CardTitle><T.H2>6. Changes to Terms</T.H2></CardTitle>
        </CardHeader>
        <CardContent>
          <T.P>
