...
import { signUpWithPasswordSchema, SignUpWithPasswordSchemaType } from '@/utils/zod-schemas/auth';
...
export function PasswordSignupForm({ next, setSuccessMessage }: PasswordSignupFormProps) {
  ...
  return (
    <Form {...form}>
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        />
        <Button className="w-full" type="submit" disabled={signUpStatus === 'executing'}>
