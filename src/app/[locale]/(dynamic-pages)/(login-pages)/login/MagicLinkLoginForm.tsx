...
export function MagicLinkLoginForm({ next, setEmailSentSuccessMessage }: MagicLinkLoginFormProps) {
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4" data-testid="magic-link-form">
        <FormInput
          id="magic-link-email"
          label="Email address"
          type="email"
