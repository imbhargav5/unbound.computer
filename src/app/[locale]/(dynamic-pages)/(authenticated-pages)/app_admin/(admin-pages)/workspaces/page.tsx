...
export default async function AdminWorkspacesList({
  ...
  const validatedSearchParams = appAdminWorkspacesFiltersSchema.parse(searchParams);
  const suspenseKey = JSON.stringify(validatedSearchParams);
  const totalPagesActionResult = await getWorkspacesTotalPagesAction(validatedSearchParams);
