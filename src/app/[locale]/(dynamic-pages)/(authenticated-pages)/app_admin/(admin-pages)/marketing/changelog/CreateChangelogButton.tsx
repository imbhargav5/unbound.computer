...
export const CreateChangelogButton: React.FC = () => {
  ...
  return (
    <Button onClick={handleCreateChangelog} disabled={createChangelogMutation.status === 'executing'}>
      <Plus className="mr-2 h-4 w-4" />
      {createChangelogMutation.status === 'executing' ? 'Creating...' : 'Create Changelog'}
    </Button>
  );
};
