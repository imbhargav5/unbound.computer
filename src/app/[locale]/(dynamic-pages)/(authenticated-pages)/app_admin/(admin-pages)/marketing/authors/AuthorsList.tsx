  ...
  return (
    ...
    >
      <div className="flex justify-between items-center mb-4">
        <Typography.H4 className="text-2xl">Manage your marketing authors</Typography.H4>
            ...
            >
              ...
              <TableCell>
                <div className="flex space-x-2">
                  ...
                  <DeleteAuthorProfileDialog authorId={profile.id} authorName={profile.display_name} />
                </div>
              </TableCell>
            </motion.tr>
          ))}
