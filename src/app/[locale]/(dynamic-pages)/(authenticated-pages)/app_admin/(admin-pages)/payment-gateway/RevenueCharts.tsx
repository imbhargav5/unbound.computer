...
export async function RevenueCharts() {
  ...
  const [revenueByMonth, subscriptionCountByMonth] = await Promise.all([
    stripePaymentGateway.superAdminScope.getRevenueByMonthBetween(startDate, endDate),
    stripePaymentGateway.superAdminScope.getSubscriptionsByMonthBetween(startDate, endDate)
  ]);
