...
export const createMarketingChangelogActionSchema = createMarketingChangelogSchema
  .extend({
...
export const updateMarketingChangelogActionSchema = updateMarketingChangelogSchema
  .extend({
    stringified_json_content: z.string(),
  })
  .omit({
