...
type StatusEnumEquivalence = MarketingFeedbackStatusEnum extends DBMarketingFeedbackStatusEnum
...
type AssertStatusEnumEquivalence = StatusEnumEquivalence extends true ? true : never;
...
export const marketingFeedbackTypeEnum = z.enum(['bug', 'feature_request', 'general']);
export type MarketingFeedbackTypeEnum = z.infer<typeof marketingFeedbackTypeEnum>;
...
type TypeEnumEquivalence = MarketingFeedbackTypeEnum extends DBMarketingFeedbackTypeEnum
...
// This will cause a type error if the types are not equivalent
type AssertTypeEnumEquivalence = TypeEnumEquivalence extends true ? true : never;

// Usage: Don't remove this, it's used to ensure that the types are equivalent
const _assertTypeEnumEquivalence: AssertTypeEnumEquivalence = true;


export const marketingFeedbackThreadPriorityEnum = z.enum(['low', 'medium', 'high']);
export type MarketingFeedbackThreadPriorityEnum = z.infer<typeof marketingFeedbackThreadPriorityEnum>;
type DBMarketingFeedbackThreadPriorityEnum = Enum<'marketing_feedback_thread_priority'>;

// Check if MarketingFeedbackThreadPriorityEnum and DBMarketingFeedbackThreadPriorityEnum are equivalent
type PriorityEnumEquivalence = MarketingFeedbackThreadPriorityEnum extends DBMarketingFeedbackThreadPriorityEnum
...
// This will cause a type error if the types are not equivalent
type AssertPriorityEnumEquivalence = PriorityEnumEquivalence extends true ? true : never;
