...
CREATE TABLE IF NOT EXISTS public.billing_plan_prices (
  ...
  gateway_plan_id VARCHAR NOT NULL REFERENCES public.billing_plans(gateway_plan_id),
...
CREATE TABLE IF NOT EXISTS public.billing_customers (
  ...
  gateway_name VARCHAR NOT NULL,
  gateway_plan_id VARCHAR REFERENCES public.billing_plans(gateway_plan_id),
...
CREATE INDEX idx_billing_payments_customer_id_gateway_name ON public.billing_payments(gateway_customer_id, gateway_name);
CREATE INDEX idx_billing_payments_plan_id ON public.billing_payments(gateway_plan_id);
CREATE INDEX idx_billing_payments_gateway_name ON public.billing_payments(gateway_name);
CREATE INDEX idx_billing_payments_gateway_customer_id ON public.billing_payments(gateway_customer_id);
-- -- Credit Logs table
...
-- functions
CREATE OR REPLACE FUNCTION "public"."get_customer_workspace_id" (customer_id_arg VARCHAR) RETURNS UUID LANGUAGE plpgsql
