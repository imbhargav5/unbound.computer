...
//  MobileClaudeCodeConversationTimeline
//
//  Mobile markdown table parsing + inline markdown tokenization.
//
    ...
    public static func tokenize(_ text: String) -> [InlineMarkdownSpan] {
        ...
        if currentIndex < text.endIndex {
            ...
            if !remainingText.isEmpty {
                spans.append(InlineMarkdownSpan(text: remainingText, style: nil))
            }
        }
