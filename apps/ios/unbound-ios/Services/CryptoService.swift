...
//  ECDH key agreement, HKDF key derivation, and XChaCha20-Poly1305 AEAD encryption.
//
...
enum CryptoError: Error, LocalizedError {
    ...
    var errorDescription: String? {
        ...
        case .invalidNonceSize:
            return "Invalid nonce size. Expected 24 bytes for XChaCha20-Poly1305."
        case .encryptionFailed:
...
struct EncryptedMessage {
    ...
    /// Parse from combined data (24-byte nonce + ciphertext)
    init(combined: Data) throws {
        guard combined.count > 24 else {
            throw CryptoError.invalidNonceSize
        }
        self.nonce = combined.prefix(24)
        self.ciphertext = combined.dropFirst(24)
    }
