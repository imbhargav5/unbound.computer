...
#Preview("Code Diff - New File") {
    ScrollView {
        CodeDiffView(diff: .constant(PreviewData.codeDiff))
    }
    .padding(.vertical)
    .background(AppTheme.backgroundPrimary)
}

#Preview("Code Diff - Mixed Changes") {
    ScrollView {
        CodeDiffView(diff: .constant(PreviewData.mixedCodeDiff))
    }
    .padding(.vertical)
    .background(AppTheme.backgroundPrimary)
}
