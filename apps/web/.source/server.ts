...
import * as __fd_glob_37 from "../src/content/docs/internals/packages/agent-runtime.mdx?collection=docs";
import * as __fd_glob_38 from "../src/content/docs/internals/packages/crypto.mdx?collection=docs";
import * as __fd_glob_40 from "../src/content/docs/internals/packages/daemon-ably.mdx?collection=docs";
import * as __fd_glob_39 from "../src/content/docs/internals/packages/daemon-ably-client.mdx?collection=docs";
import * as __fd_glob_41 from "../src/content/docs/internals/packages/daemon-falco.mdx?collection=docs";
import * as __fd_glob_42 from "../src/content/docs/internals/packages/daemon-nagato.mdx?collection=docs";
import * as __fd_glob_43 from "../src/content/docs/internals/packages/git-worktree.mdx?collection=docs";
import { default as __fd_glob_4 } from "../src/content/docs/internals/packages/meta.json?collection=docs";
import * as __fd_glob_44 from "../src/content/docs/internals/packages/observability.mdx?collection=docs";
import * as __fd_glob_45 from "../src/content/docs/internals/packages/protocol.mdx?collection=docs";
import * as __fd_glob_46 from "../src/content/docs/internals/packages/redis.mdx?collection=docs";
import * as __fd_glob_47 from "../src/content/docs/internals/packages/session.mdx?collection=docs";
import * as __fd_glob_48 from "../src/content/docs/internals/packages/transport-reliability.mdx?collection=docs";
import * as __fd_glob_49 from "../src/content/docs/internals/packages/typescript-config.mdx?collection=docs";
import * as __fd_glob_50 from "../src/content/docs/internals/packages/web-session.mdx?collection=docs";
import { default as __fd_glob_5 } from "../src/content/docs/internals/web/meta.json?collection=docs";
import * as __fd_glob_51 from "../src/content/docs/internals/web/navigation-fns.mdx?collection=docs";
import * as __fd_glob_52 from "../src/content/docs/internals/web/request-memoization.mdx?collection=docs";
import * as __fd_glob_53 from "../src/content/docs/internals/web/rsc-data.mdx?collection=docs";
...
export const docs = await create.docs(
  ...
  },
  {
    ...
    "internals/packages/agent-runtime.mdx": __fd_glob_37,
    "internals/packages/crypto.mdx": __fd_glob_38,
    "internals/packages/daemon-ably-client.mdx": __fd_glob_39,
    "internals/packages/daemon-ably.mdx": __fd_glob_40,
    "internals/packages/daemon-falco.mdx": __fd_glob_41,
    "internals/packages/daemon-nagato.mdx": __fd_glob_42,
    "internals/packages/git-worktree.mdx": __fd_glob_43,
    "internals/packages/observability.mdx": __fd_glob_44,
    "internals/packages/protocol.mdx": __fd_glob_45,
    "internals/packages/redis.mdx": __fd_glob_46,
    "internals/packages/session.mdx": __fd_glob_47,
    "internals/packages/transport-reliability.mdx": __fd_glob_48,
    "internals/packages/typescript-config.mdx": __fd_glob_49,
    "internals/packages/web-session.mdx": __fd_glob_50,
    "internals/web/navigation-fns.mdx": __fd_glob_51,
    "internals/web/request-memoization.mdx": __fd_glob_52,
    "internals/web/rsc-data.mdx": __fd_glob_53,
  }
);
