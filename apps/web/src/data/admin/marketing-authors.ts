...
export const createAuthorProfileAction = adminActionClient
  .inputSchema(createMarketingAuthorProfileSchema)
  .action(async ({ parsedInput }) => {
    ...
    remoteCache.admin.blog.authors.updateTag();
    return data;
  });
...
export const updateAuthorProfileAction = adminActionClient
  .inputSchema(updateMarketingAuthorProfileSchema)
  .action(async ({ parsedInput }) => {
...
export const deleteAuthorProfileAction = adminActionClient
  .inputSchema(deleteMarketingAuthorProfileSchema)
...
export const uploadMarketingAuthorImageAction = adminActionClient
  .inputSchema(uploadMarketingAuthorImageSchema)
