  ...
  return (
    <div className="fade-in-0 slide-in-from-bottom-4 animate-in space-y-8 duration-500">
      ...
      <div className="space-y-2">
        ...
        <p className="text-white/50">Get started with Unbound in seconds</p>
      </div>
      ...
      <p className="text-center text-white/30 text-xs">
        ...
        <Link className="text-white/50 hover:text-white" href="/terms">
          Terms of Service
        </Link>{" "}
        and{" "}
        <Link className="text-white/50 hover:text-white" href="/privacy">
          Privacy Policy
        </Link>
      </p>
