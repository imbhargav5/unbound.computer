...
//  unbound-macos
//
//  Secure key storage using macOS Keychain API for device-rooted trust architecture.
//
...
/// Service for securely storing and retrieving cryptographic keys using macOS Keychain
final class KeychainService {
    static let shared = KeychainService()

    private let serviceName = "com.unbound.macos"
