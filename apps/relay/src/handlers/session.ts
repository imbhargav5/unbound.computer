...
import { connectionManager, streamSubscriber } from "../managers/index.js";
...
export function handleSubscribe(
  ...
  // Subscribe to Redis stream for conversation events
  streamSubscriber.subscribe(sessionId);
  ...
  log.info(
    ...
    "Client subscribed to session and stream"
  );
}
...
export function handleUnsubscribe(
  ...
  streamSubscriber.unsubscribe(sessionId);
